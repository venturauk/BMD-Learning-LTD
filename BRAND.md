...
| --- | --- | --- |
| **B** | Behaviour | The everyday actions, habits and interactions that shape performance and culture. |
| **M** | Mindset | The beliefs, confidence and attitude that unlock potential. |
| **D** | Development | Practical, ongoing growth that lasts beyond the room. |
...
| Token | Hex | Use |
| --- | --- | --- |
| Ink (Navy) | `#122742` | Headings, primary text, dark sections |
| Growth Teal | `#1FA199` | Primary accent, buttons, highlights |
| Teal Dark | `#15788F` | Links, hover states |
| Teal Light | `#3FBFB0` | List markers, supporting accents |
| Amber | `#F4B860` | Warm highlight (used sparingly) |
| Background | `#F7F9FB` | Page background |
| Surface | `#FFFFFF` | Cards and alternate sections |
| Text | `#233140` | Body copy |
...
comfortable 17px with a 1.65 line-height for readability.

---

## 6. Brand personality

Professional · Approachable · Reliable · Insightful · Collaborative · Progressive
...
- Supportive without being informal.
...
**Practical** · **Experienced** · **Flexible** · **Collaborative** · **Results-Focused**
